...
exports.addRecord = async(req, res) => {
    let {email, name, rating, price, content, lat, lng} = req.body;
    // let currTime = new Date().toISOString();
    console.log('INSERT INTO "tblRecord"(email, name, rating, price, content, lat, lng) VALUES ($1, $2, $3, $4, $5, $6, $7)',
        [email, name, rating, price, content, lat, lng]);
    let {recordRows} = await db.query(
        'INSERT INTO "tblRecord"(email, name, rating, price, content, lat, lng) VALUES ($1, $2, $3, $4, $5, $6, $7)',
        [email, name, rating, price, content, lat, lng]
    )
    ...
    res.status(200).send({
        ...
        body: {
            record: {email, name, rating, price, content, lat, lng}
        }
    })
};
